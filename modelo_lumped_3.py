...
class BasePainel:
    def __init__(self, id, nome, vol, n, e, a, rho, k, cp, **kwargs ):
        self.id = id
        self.nome = nome
        self.vol = vol
        self.n = n
...
class Parafusos:
    def __init__(self, id, nome, vol, rho, k, cp,**kwargs):
        self.id = id
        self.nome = nome
        self.vol = vol
        self.rho = rho
...
a = 0.92
"""
substrato1 = Substrato('1', 'substrato 1',Lx=0.002, vol=0.000002696, area=0.002696, a=0.92, e=0.899, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato2 = Substrato('2', 'substrato 2',Lx=0.002, vol=0.000002696, area=0.002696, a=0.92, e=0.899, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato3 = Substrato('3', 'substrato 3',Lx=0.002, vol=0.000002696, area=0.002696, a=0.92, e=0.899, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato4 = Substrato('4', 'substrato 4',Lx=0.002, vol=0.000002696, area=0.002696, a=0.92, e=0.899, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato5 = Substrato('5', 'substrato 5',Lx=0.002, vol=0.000002696, area=0.002696, a=0.92, e=0.899, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato6 = Substrato('6', 'substrato 6',Lx=0.002, vol=0.000002696, area=0.002696, a=0.92, e=0.899, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato7 = Substrato('7', 'substrato 7',Lx=0.002, vol=0.000002696, area=0.002696, a=0.92, e=0.899, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato8 = Substrato('8', 'substrato 8',Lx=0.002, vol=0.000002696, area=0.002696, a=0.92, e=0.899, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
...
e = 0.02
"""
basecobre1 = BaseCobre('13', 'base cobre 1', vol=0.0000084, n='i', e=0.02, a=0.32, rho=8580.0, k=122.9,
                       cp=378.0)
basecobre2 = BaseCobre('14', 'base cobre 2', vol=0.0000084, n='j', e=0.02, a=0.32, rho=8580.0, k=122.9,
                       cp=378.0)
basecobre3 = BaseCobre('15', 'base cobre 3', vol=0.0000084, n='i', e=0.02, a=0.32, rho=8580.0, k=122.9,
                       cp=378.0)
basecobre4 = BaseCobre('16', 'base cobre 4', vol=0.0000084, n='j', e=0.02, a=0.32, rho=8580.0, k=122.9,
                       cp=378.0)
...
a = 0.13
"""
tampa1 = Tampa('17', 'Tampa 1', vol=0.00002914719, n='k', e=0.3, a=0.13, rho=2770.0, k=121.2, cp=961.2, area_rad=0.00971573)
tampa2 = Tampa('18', 'Tampa 2', vol=0.00002914719, n='k', e=0.3, a=0.13, rho=2770.0, k=121.2, cp=961.2, area_rad=0.00971573)
...
e = 0.76
"""
pcb1 = PCB('19', 'PCB 1', vol=0.00001911519, n='k', e=0.76, a=0.07, rho=1850.0, k=0.81, cp=1100.0)
pcb2 = PCB('20', 'PCB 2', vol=0.00001911519, n='k', e=0.76, a=0.07, rho=1850.0, k=0.81, cp=1100.0)
pcb3 = PCB('21', 'PCB 3', vol=0.00001911519, n='k', e=0.76, a=0.07, rho=1850.0, k=0.81, cp=1100.0)
pcb4 = PCB('22', 'PCB 4', vol=0.00001911519, n='k', e=0.76, a=0.07, rho=1850.0, k=0.81, cp=1100.0)
...
estrutura_vertical1 = Estrutura('23', 'Estrutura Vertical 1', vol=0.000028, n='i', e=0.3, a=0.5,
                                rho=2770.0, k=121.2, cp=961.2, area_rad=0.0008)
...
estrutura_horizontal1 = Estrutura('31', 'Estrutura Horizontal 1', vol=0.000002352, n='i', e=0.3, a=0.13,
                                  rho=2770.0, k=121.2, cp=961.2)
estrutura_horizontal2 = Estrutura('32', 'Estrutura Horizontal 2', vol=0.000002352, n='i', e=0.3, a=0.13,
                                  rho=2770.0, k=121.2, cp=961.2)
estrutura_horizontal3 = Estrutura('33', 'Estrutura Horizontal 3', vol=0.000002352, n='i', e=0.3, a=0.13,
                                  rho=2770.0, k=121.2, cp=961.2)
estrutura_horizontal4 = Estrutura('34', 'Estrutura Horizontal 4', vol=0.000002352, n='i', e=0.3, a=0.13,
                                  rho=2770.0, k=121.2, cp=961.2)
estrutura_horizontal5 = Estrutura('35', 'Estrutura Horizontal 5', vol=0.000002352, n='j', e=0.3, a=0.13,
                                  rho=2770.0, k=121.2, cp=961.2)
estrutura_horizontal6 = Estrutura('36', 'Estrutura Horizontal 6', vol=0.000002352, n='j', e=0.3, a=0.13,
                                  rho=2770.0, k=121.2, cp=961.2)
...
a = 0.13
"""
parafuso1 = Parafusos('47', 'Parafuso 1', vol=0.0000020412, rho=2770.0, k=121.2, cp=961.2)
parafuso2 = Parafusos('48', 'Parafuso 2', vol=0.0000020412, rho=2770.0, k=121.2, cp=961.2)
parafuso3 = Parafusos('49', 'Parafuso 3', vol=0.0000020412, rho=2770.0, k=121.2, cp=961.2)
parafuso4 = Parafusos('50', 'Parafuso 4', vol=0.0000020412, rho=2770.0, k=121.2, cp=961.2)
parafuso5 = Parafusos('51', 'Parafuso 5', vol=0.0000020412, rho=2770.0, k=121.2, cp=961.2)
parafuso6 = Parafusos('52', 'Parafuso 6', vol=0.0000020412, rho=2770.0, k=121.2, cp=961.2)
parafuso7 = Parafusos('53', 'Parafuso 7', vol=0.0000020412, rho=2770.0, k=121.2, cp=961.2)
parafuso8 = Parafusos('54', 'Parafuso 8', vol=0.0000020412, rho=2770.0, k=121.2, cp=961.2)
parafuso9 = Parafusos('55', 'Parafuso 9', vol=0.0000020412, rho=2770.0, k=121.2, cp=961.2)
parafuso10 = Parafusos('56', 'Parafuso 10', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
parafuso11 = Parafusos('57', 'Parafuso 11', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
parafuso12 = Parafusos('58', 'Parafuso 12', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
parafuso13 = Parafusos('59', 'Parafuso 13', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
parafuso14 = Parafusos('60', 'Parafuso 14', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
parafuso15 = Parafusos('61', 'Parafuso 15', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
parafuso16 = Parafusos('62', 'Parafuso 16', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
parafuso17 = Parafusos('63', 'Parafuso 17', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
parafuso18 = Parafusos('64', 'Parafuso 18', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
parafuso19 = Parafusos('65', 'Parafuso 19', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
parafuso20 = Parafusos('66', 'Parafuso 20', vol=0.0000002856, rho=2770.0, k=121.2, cp=961.2)
...
conduc = {substrato1.id: [basepainel1.id],
          ...
          estrutura_horizontal5.id: [basecobre3.id, estrutura_horizontal13.id, estrutura_vertical5.id,
                                     estrutura_vertical6.id],
          estrutura_horizontal6.id: [basecobre3.id, estrutura_horizontal14.id, estrutura_vertical5.id,
                                     estrutura_vertical6.id],
          estrutura_horizontal7.id: [basecobre4.id, estrutura_horizontal15.id, estrutura_vertical7.id,
                                     estrutura_vertical8.id],
          estrutura_horizontal8.id: [basecobre4.id, estrutura_horizontal16.id, estrutura_vertical7.id,
                                     estrutura_vertical8.id],
          tampa1.id: [estrutura_horizontal1.id, estrutura_horizontal3.id, estrutura_horizontal5.id,
                      estrutura_horizontal7.id, parafuso1.id, parafuso2.id, parafuso3.id, parafuso4.id],
          tampa2.id: [estrutura_horizontal2.id, estrutura_horizontal4.id, estrutura_horizontal6.id,
                      estrutura_horizontal8.id, parafuso5.id, parafuso6.id, parafuso7.id, parafuso8.id],
          parafuso1.id: [tampa1.id, pcb1.id],
          parafuso2.id: [tampa1.id, pcb1.id],
          parafuso3.id: [tampa1.id, pcb1.id],
          parafuso4.id: [tampa1.id, pcb1.id],
          parafuso5.id: [tampa2.id, pcb4.id],
          parafuso6.id: [tampa2.id, pcb4.id],
          parafuso7.id: [tampa2.id, pcb4.id],
          parafuso8.id: [tampa2.id, pcb4.id],
          ...
          estrutura_horizontal9.id: [tampa1.id, estrutura_vertical1.id, estrutura_vertical8.id,
                                     estrutura_horizontal1.id],
          estrutura_horizontal10.id: [tampa1.id, estrutura_vertical2.id, estrutura_vertical3.id,
                                      estrutura_horizontal3.id],
          estrutura_horizontal11.id: [tampa1.id, estrutura_vertical4.id, estrutura_vertical5.id,
                                      estrutura_horizontal5.id],
          estrutura_horizontal12.id: [tampa1.id, estrutura_vertical6.id, estrutura_vertical7.id,
                                      estrutura_horizontal7.id],
          estrutura_horizontal13.id: [tampa2.id, estrutura_vertical1.id, estrutura_vertical8.id,
                                      estrutura_horizontal2.id],
          estrutura_horizontal14.id: [tampa2.id, estrutura_vertical2.id, estrutura_vertical3.id,
                                      estrutura_horizontal4.id],
          estrutura_horizontal15.id: [tampa2.id, estrutura_vertical4.id, estrutura_vertical5.id,
                                      estrutura_horizontal6.id],
          estrutura_horizontal16.id: [tampa2.id, estrutura_vertical6.id, estrutura_vertical7.id,
                                      estrutura_horizontal6.id]
          }
...
L = {'1 9': '0.0005', '2 9': '0.0005', '9 1': '0.001', '9 2': '0.001', '9 13': '0.001', '13 9': '0.0005',
     ...
     '16 37': '0.0005', '16 38': '0.0005', '31 13': '0.001', '31 39': '0.004', '31 23': '0.042', '31 24': '0.042',
     '32 13': '0.001', '32 40': '0.004', '32 23': '0.042', '32 24': '0.042', '33 14': '0.001', '33 41': '0.004',
     '33 25': '0.042', '33 26': '0.042', '34 14': '0.001', '34 42': '0.004', '34 25': '0.042', '34 26': '0.042',
     '35 15': '0.001', '35 43': '0.004', '35 27': '0.042', '35 28': '0.042', '36 15': '0.001', '36 44': '0.004',
     '36 27': '0.042', '36 28': '0.042', '37 16': '0.001', '37 45': '0.004', '37 29': '0.042', '37 30': '0.042',
     '38 16': '0.001', '38 46': '0.004', '38 29': '0.042', '38 30': '0.042', '17 31': '0.0015', '17 33': '0.0015',
     '17 35': '0.0015', '17 37': '0.0015', '17 47': '0.0015', '17 48': '0.0015', '17 49': '0.0015', '17 50': '0.0015',
     '18 32': '0.0015', '18 34': '0.0015', '18 36': '0.0015', '18 38': '0.0015', '18 51': '0.0015', '18 52': '0.0015',
     '18 53': '0.0015', '18 54': '0.0015', '47 17': '0.007', '47 19': '0.007', '48 17': '0.007', '48 19': '0.007',
     '49 17': '0.007', '49 19': '0.007', '50 17': '0.007', '50 19': '0.007', '51 18': '0.007', '51 22': '0.007',
     '52 18': '0.007', '52 22': '0.007', '53 18': '0.007', '53 22': '0.007', '54 18': '0.007', '54 22': '0.007',
     '55 19': '0.01', '55 20': '0.01', '56 19': '0.01', '56 20': '0.01', '57 19': '0.01', '57 20': '0.01',
     '58 19': '0.01', '58 20': '0.01', '59 20': '0.01', '59 21': '0.01', '60 20': '0.01', '60 21': '0.01',
     '61 20': '0.01', '61 21': '0.01', '62 20': '0.01', '62 21': '0.01', '63 21': '0.01', '63 22': '0.01',
     '64 21': '0.01', '64 22': '0.01', '65 21': '0.01', '65 22': '0.01', '66 21': '0.01', '66 22': '0.01',
     '19 47': '0.0015', '19 48': '0.0015', '19 49': '0.0015', '19 50': '0.0015', '19 55': '0.0015', '19 56': '0.0015',
     '19 57': '0.0015', '19 58': '0.0015', '20 55': '0.0015', '20 56': '0.0015', '20 57': '0.0015', '20 58': '0.0015',
     '20 59': '0.0015', '20 60': '0.0015', '20 61': '0.0015', '20 62': '0.0015', '21 59': '0.0015', '21 60': '0.0015',
     '21 61': '0.0015', '21 62': '0.0015', '21 63': '0.0015', '21 64': '0.0015', '21 65': '0.0015', '21 66': '0.0015',
     '22 63': '0.0015', '22 64': '0.0015', '22 65': '0.0015', '22 66': '0.0015', '22 51': '0.0015', '22 52': '0.0015',
     '22 53': '0.0015', '22 54': '0.0015', '23 31': '0.004', '23 32': '0.004', '23 24': '0.004', '24 33': '0.004',
     '24 34': '0.004', '24 23': '0.004', '25 33': '0.004', '25 34': '0.004', '25 26': '0.004', '26 35': '0.004',
     '26 36': '0.004', '26 25': '0.004', '27 35': '0.004', '27 36': '0.004', '27 28': '0.004', '28 37': '0.004',
     '28 38': '0.004', '28 27': '0.004', '29 37': '0.004', '29 38': '0.004', '29 30': '0.004', '30 31': '0.004',
     '30 32': '0.004', '30 29': '0.004', '39 17': '0.001', '39 23': '0.042', '39 30': '0.042', '39 31': '0.004',
     '40 17': '0.001', '40 24': '0.042', '40 25': '0.042', '40 33': '0.004', '41 17': '0.001', '41 26': '0.042',
     '41 27': '0.042', '41 35': '0.004', '42 17': '0.001', '42 28': '0.042', '42 29': '0.042', '42 37': '0.004',
     '43 18': '0.001', '43 23': '0.042', '43 30': '0.042', '43 32': '0.004', '44 18': '0.001', '44 24': '0.042',
     '44 25': '0.042', '44 34': '0.004', '45 18': '0.001', '45 26': '0.042', '45 27': '0.042', '45 36': '0.004',
     '46 18': '0.001', '46 28': '0.042', '46 29': '0.042', '46 36': '0.004'}
A = {'1 9': '0.002696', '2 9': '0.002696', '9 1': '0.002696', '9 2': '0.002696', '9 13': '0.0084', '13 9': '0.0084',
     ...
     '12 7': '0.002696', '12 8': '0.002696', '12 16': '0.0084', '16 12': '0.0084', '16 37': '0.00672',
     '16 38': '0.000672', '31 13': '0.000672', '31 39': '0.000168', '31 23': '0.000016', '31 24': '0.000016',
     '32 13': '0.000672', '32 40': '0.000168', '32 23': '0.00016', '32 24': '0.00016', '33 14': '0.000672',
     '33 41': '0.000168', '33 25': '0.00016', '33 26': '0.00016', '34 14': '0.000672', '34 42': '0.000168',
     '34 25': '0.00016', '34 26': '0.00016', '35 15': '0.000672', '35 43': '0.000168', '35 27': '0.00016',
     '35 28': '0.00016', '36 15': '0.000672', '36 44': '0.000168', '36 27': '0.00016', '36 28': '0.00016',
     '37 16': '0.000672', '37 45': '0.000168', '37 29': '0.00016', '37 30': '0.00016', '38 16': '0.000672',
     '38 46': '0.000168', '38 29': '0.00016', '38 30': '0.00016', '17 31': '0.000672', '17 33': '0.000672',
     '17 35': '0.000672', '17 37': '0.000672', '17 47': '0.00001458', '17 48': '0.00001458', '17 49': '0.00001458',
     '17 50': '0.00001458', '18 32': '0.000672', '18 34': '0.000672', '18 36': '0.000672', '18 38': '0.000672',
     '18 51': '0.00001458', '18 52': '0.00001458', '18 53': '0.00001458', '18 54': '0.00001458', '47 17': '0.00001458',
     '47 19': '0.00001458', '48 17': '0.00001458', '48 19': '0.00001458', '49 17': '0.00001458', '49 19': '0.00001458',
     '50 17': '0.00001458', '50 19': '0.00001458', '51 18': '0.00001458', '51 22': '0.00001458', '52 18': '0.00001458',
     '52 22': '0.00001458', '53 18': '0.00001458', '53 22': '0.00001458', '54 18': '0.00001458', '54 22': '0.00001458',
     ...
     '22 54': '0.00001458', '23 31': '0.000016', '23 32': '0.000016', '23 24': '0.000224', '24 33': '0.000016',
     '24 34': '0.000016', '24 23': '0.000224', '25 33': '0.000016', '25 34': '0.000016', '25 26': '0.000224',
     '26 35': '0.000016', '26 36': '0.000016', '26 25': '0.000224', '27 35': '0.000016', '27 36': '0.000016',
     '27 28': '0.000224', '28 37': '0.000016', '28 38': '0.000016', '28 27': '0.000224', '29 37': '0.000016',
     '29 38': '0.000016', '29 30': '0.000224', '30 31': '0.000016', '30 32': '0.000016', '30 29': '0.000224',
     '39 17': '0.000672', '39 23': '0.000016', '39 30': '0.000016', '39 31': '0.000168', '40 17': '0.000672',
     '40 24': '0.000016', '40 25': '0.000016', '40 33': '0.000168', '41 17': '0.000672', '41 26': '0.000016',
     '41 27': '0.000016', '41 35': '0.000168', '42 17': '0.000672', '42 28': '0.000016', '42 29': '0.000016',
     '42 37': '0.000168', '43 18': '0.000672', '43 23': '0.000016', '43 30': '0.000016', '43 32': '0.000168',
     '44 18': '0.000672', '44 24': '0.000016', '44 25': '0.000016', '44 34': '0.000168', '45 18': '0.000672',
     '45 26': '0.000016', '45 27': '0.000016', '45 36': '0.000168', '46 18': '0.000672', '46 28': '0.000016',
     '46 29': '0.000016', '46 36': '0.000168'}
...
face5 = CavidadeFace(X=0.08, Y=0.08, n='k', e=tampa1.e, comp=tampa1.id)
...
face30 = CavidadeFace(X=0.08, Y=0.08, n='k', e=tampa2.e, comp=tampa2.id)
...
# matriz com as radiações externas incidentes

# calor obtido da simulacao orbital
...
nos_rad = {'face 1': [substrato1.id, substrato2.id, basepainel1.id, estrutura_vertical1.id, estrutura_vertical8.id],
           'face 2': [substrato3.id, substrato4.id, basepainel1.id, estrutura_vertical2.id, estrutura_vertical3.id],
           'face 3': [substrato5.id, substrato6.id, basepainel1.id, estrutura_vertical4.id, estrutura_vertical5.id],
           'face 4': [substrato7.id, substrato8.id, basepainel1.id, estrutura_vertical6.id, estrutura_vertical7.id],
           'face 5': [tampa1.id],
           'face 6': [tampa2.id]
}
...
for lista_no in Nos_rad:
    for no in lista_no:
        for comp in nos:
            if no == comp.id:
                j = int(no)
                area_rad[j-1] = comp.kwargs['area_rad']
...
def lumped(calor, fg, area_rad, nos, K_m, nos_ext):
            ...
            while cont < Dt_orbita:
                ...
                for i in range(0, len(nos)):
                    for j in range(0, len(nos)):
                        ...
                        Trad[j] = (sig * nos[i].e * area_rad[i] * fg[i, j] * (
                    ...
                    Temp_pos[i] = Temp_ini[i] + (Dt_termico / C_i) * (sum(Tcond) + sum(Trad) +
                                                                      area_rad[i] * calor[k, i] * (nos[i].a)
                                                                      - sig * area_rad[i] * nos[i].e * (Temp_ini_ext[i] ** 4))
...
lumped(calor2, rad, area_rad, nos, K_m, nos_rad)
